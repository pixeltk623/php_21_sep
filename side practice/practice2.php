...
define('BASE_URL', 'http://localhost/php_21_sep/side%20practice');
...
$query = "SELECT * FROM amit_table";

$result = mysqli_query($conn, $query);

function formatArray(object $result)
{
    echo "<pre>";
    print_r($result);
    echo "</pre>";
...
<body>
    <div class="container mt-3">
        ...
        <a href="practice.php" class="btn btn-primary mb-3">Add New Employee</a>
