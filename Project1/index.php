  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <img src="FrontEnd_Assets/img/about-img.jpg" class="img-fluid" alt="">
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="card">
              <img src="FrontEnd_Assets/img/why-us-1.jpg" class="card-img-top" alt="...">
              <div class="card-icon">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="card">
              <img src="FrontEnd_Assets/img/why-us-2.jpg" class="card-img-top" alt="...">
              <div class="card-icon">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="card">
              <img src="FrontEnd_Assets/img/why-us-3.jpg" class="card-img-top" alt="...">
              <div class="card-icon">
